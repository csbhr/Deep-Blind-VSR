...
class Inference:
    def __init__(self, args):
        ...
        self.large_model = args.large_model
        ...
        self.logger.write_log('quick_test: {}'.format(self.quick_test))
        self.logger.write_log('large_model: {}'.format(self.large_model))
        ...
        if self.large_model:
            self.net = PWC_Recons(
                n_colors=3, n_sequence=5, extra_RBS=3, recons_RBS=20, n_feat=128, scale=4, device=self.device
            )
        else:
            self.net = PWC_Recons(
                n_colors=3, n_sequence=5, extra_RBS=1, recons_RBS=3, n_feat=128, scale=4, device=self.device
            )
        ...
        with torch.no_grad():
            ...
            for v in videos:
                ...
                for in_seq, gt_seq in zip(input_seqs, gt_seqs):
                    ...
                    output_dict, _ = self.net({'x': in_tensor})
...
if __name__ == '__main__':
    ...
    parser.add_argument('--quick_test', type=str, default='.',
                        help='Gaussian_REDS4/Gaussian_Vid4/Gaussian_SPMCS/NonGaussian_REDS4/NonGaussian_REDS4_L')

    parser.add_argument('--large_model', action='store_true', help='using large model if true')
    ...
    if args.quick_test == 'Gaussian_REDS4':
        args.scale = 4
        args.input_path = '../dataset/REDS4_BlurDown_Gaussian/blurdown_x4'
        args.gt_path = '../dataset/REDS4_BlurDown_Gaussian/sharp'
        args.model_path = '../pretrain_models/gaussian_e1r3.pt'
        args.infer_flag = 'Gaussian_REDS4'
    elif args.quick_test == 'Gaussian_Vid4':
        args.scale = 4
        args.input_path = '../dataset/Vid4_BlurDown_Gaussian/blurdown_x4'
        args.gt_path = '../dataset/Vid4_BlurDown_Gaussian/sharp'
        args.model_path = '../pretrain_models/gaussian_e1r3.pt'
        args.infer_flag = 'Gaussian_Vid4'
    elif args.quick_test == 'Gaussian_SPMCS':
        args.scale = 4
        args.input_path = '../dataset/SPMCS_BlurDown_Gaussian/blurdown_x4'
        args.gt_path = '../dataset/SPMCS_BlurDown_Gaussian/sharp'
        args.model_path = '../pretrain_models/gaussian_e1r3.pt'
        args.infer_flag = 'Gaussian_SPMCS'
    elif args.quick_test == 'NonGaussian_REDS4':
        args.scale = 4
        args.input_path = '../dataset/REDS4_BlurDown_NonGaussian/blurdown_x4'
        args.gt_path = '../dataset/REDS4_BlurDown_NonGaussian/sharp'
        args.model_path = '../pretrain_models/kg_e1r3.pt'
        args.infer_flag = 'NonGaussian_REDS4'
    elif args.quick_test == 'NonGaussian_REDS4_L':
        args.scale = 4
        args.large_model = True
        args.input_path = '../dataset/REDS4_BlurDown_NonGaussian/blurdown_x4'
        args.gt_path = '../dataset/REDS4_BlurDown_NonGaussian/sharp'
        args.model_path = '../pretrain_models/kg_e3r20.pt'
        args.infer_flag = 'NonGaussian_REDS4_L'
